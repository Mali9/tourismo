...
<div class="container">  
    ...
    <?php echo form_open("Login/guide_register", array('id' => 'contact', 'enctype' => 'multipart/form-data')); ?>
    <h3>Register</h3>
    ...
    <fieldset>
        <input placeholder="Language " type="text" name="language"  required onblur="get('lang_error', this.value);">
    </fieldset>
    <div  style="float: right;position: relative;right: 150px;top:0px;color: green;font-size: 20px;font-family: cursive" id="lang_error"></div>
    <fieldset>
