...
<html>
    <head>
        ...
        <link rel="Stylesheet" href="<?php base_url(); ?>css/car_owner.css"></link>
    </head>
    <body>
        <div class="container">
            <div class="bar">
            ...
            <div class="bdy">
                ...
                <h1><font color="#f79100">CAR OWNER </font>TOURISM</h1>
                <?php
                $item = 0;
                ...
                $id = $row->carOwner_id;
                echo '
                        <a href="Car_owner/prof?sub='.$id.'">
                        <div class="d1" style="background-image:url('.$row->car_pic.');">
                            <div>
                                <h3>'.$row->username.'<br><font color="#f79100">'.$row->car_type.'</font></h3>
                            </div>
                        </div>
                    </a>
                    ';
    ...
    <script src="<?php base_url(); ?>js/jquery-3.1.1.js"></script>
    <script src="<?php base_url(); ?>js/car_owner.js"></script>
</body>
</html>