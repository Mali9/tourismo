...
<div>
<h4><a style="text-decoration: none;" href="<?php echo base_url();?>Hire/delete_tour/<?= $value?>">Delete</a></h4>
</div>
<?php
...
<div>
<h4><a style="text-decoration: none;" href="<?php echo base_url();?>Hire/read_tour/<?= $value?>">mark as Readed</a></h4>
</div>
<?php
